...
class PluginUddoktaPayBankCallback extends PluginCallback
{
    public function processCallback()
    {
        $cPlugin = new Plugin('', 'uddoktapaybank', $this->user);
        $apiKey = trim($cPlugin->GetPluginVariable("plugin_uddoktapaybank_API KEY"));
        $apiBaseURL = trim($cPlugin->GetPluginVariable("plugin_uddoktapaybank_API URL"));
        ...
        $exchangeRate = !empty($cPlugin->GetPluginVariable("plugin_uddoktapaybank_Exchange Rate")) ? $cPlugin->GetPluginVariable("plugin_uddoktapaybank_Exchange Rate") : 1;
        ...
        $cPlugin = new Plugin($invoiceId, 'uddoktapaybank', $this->user);
